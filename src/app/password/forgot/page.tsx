...
const ForgotPasswordPage = () => {
  ...
  return (
    <><ToastContainer /><div className="relative min-h-screen flex justify-center items-center bg-gradient-to-tr from-[#00a8e8] to-[#007ea7] overflow-hidden">
    ...
    />
          ...
          <h2 className='text-center text-gray-600 font-sans'>Enter your email and we&apos;ll help you reset your password.</h2>
